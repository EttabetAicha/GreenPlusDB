    ...
    public class Main {
        ...
        public static void calculateAverageConsumption() {
            try {
                ...
                double averageConsumption = consommationService.calculateConsommationMoyenne(startDate, endDate, userId);
                System.out.printf("Average consumption for user %d between %s and %s: %.2f Euros%n",
                        userId, startDate, endDate, averageConsumption);

            } catch (SQLException e) {
                System.out.println("Error calculating average consumption: " + e.getMessage());
            } catch (Exception e) {
